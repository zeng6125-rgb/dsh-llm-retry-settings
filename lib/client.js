...
function CodeChips({ selected, disabled, onToggle, onClear }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "dlr-chipsWrap", children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "dlr-chips", children: [
      picked.map(({ code, desc, warn }) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        Chip,
        {
          code,
          title: desc,
      ...
      picked.length + custom.length > 0 && rest.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "dlr-chipSep" }),
      rest.map(({ code, desc, warn }) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        Chip,
        {
          code,
          title: desc,
