...
var summaryOf = (cfg) => `enabled=${cfg.enabled} codes=${cfg.retryableCodes.length} maxRetries=${cfg.maxRetries} backoff=${cfg.initialDelayMs}~${cfg.maxDelayMs}ms jitter=${cfg.jitterRatio} autoContinue=${cfg.autoContinue} maxContinuations=${cfg.maxContinuations}`;
